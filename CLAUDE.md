...
| | GET | `/api/transactions?category_id=uuid1,uuid2` | Filter by category(s) |
...
| **Transactions** | 8 endpoints | Repository, Service, Controller, Resource, Tests | 29 tests | ✅ |
...
GET /api/transactions (paginated, sortable)
    ...
    - category_id: filter by category UUID(s), comma-separated for multiple
